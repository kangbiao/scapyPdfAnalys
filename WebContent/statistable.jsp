	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$(".glyphicon-minus-sign").click(function() {
				$(this).prevAll().not(":hidden").first().hide();
			});
			//增加公司按钮
			$(".glyphicon-plus-sign").click(function() {
				$(this).prevAll().filter(":hidden").last().show();
			});
			//获取表格数据
			$("#filter").click(function() {
				...
				var status="";
				var temp = 0;
				//console.log($(this).parent().parent().parent().children().not(":hidden").not("span"));
				$(this).parent().parent().parent().children().not(":hidden").not("span").each(function() {
